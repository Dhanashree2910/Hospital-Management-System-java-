...
select {
   ...
   <body >
    ...
    <input type="number" class="form-control" id="userid" name="userid" aria-describedby="email"  maxlength="40"  required>
  ...
  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Docter Id</label>
    <input type="number" class="form-control" id="doc_id" name="doc_id" aria-describedby="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required>
    <div id="emailHelp" class="form-text" ></div>
  </div>
    ...
    <input type="text" class="form-control" id="time" name="time" aria-describedby="email"  required>
    <div id="emailHelp" class="form-text" ></div>
  </div>
...
<div class="mb-3">
    ...
    <input type="text" class="form-control" id="reason" name="reason" aria-describedby="email"  required>
    <div id="emailHelp" class="form-text" ></div>
  </div>
</form>
</body>
