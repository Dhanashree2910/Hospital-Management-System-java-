	...
	"><a class ="navbar-brand 
		...
		<div class ="container-fluid" style="margin-top: 30px "><!--provide full width container spanning entire width tp 100%-->
			<div class ="row "><!--start row of slide bar -->
              ...
              <li><a href ="delete.jsp?id=<%= session.getAttribute("id") %>"><i class="fa fa-eye fa-lg"  style="color: black"></i><font color="crimson" size=4px><b> &nbsp Delete</b></font></a></li><br>

              <li><a href ="Logout?id=<%= session.getAttribute("id") %>"><i class="fa fa-power-off fa-lg"  style="color: black"></i><font color="crimson" size=4px><b> &nbsp Logout</b></font></a></li><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br><br>
