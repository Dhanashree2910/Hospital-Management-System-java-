	...
	"><a class ="navbar-brand 
		...
		<div class ="container-fluid" style="margin-top: 30px "><!--provide full width container spanning entire width tp 100%-->
			<div class ="row "><!--start row of slide bar -->
              ...
              <li><a href ="profile1.jsp?id=<%= session.getAttribute("id") %>"><i class="fa fa-eye fa-lg"  style="color: black"></i><font color="crimson" size=4px><b> &nbsp View Profile</b></font></a></li><br>
					<li><a href ="viewschedule.jsp?<%= session.getAttribute("id") %>"><i class="fa fa-plus-circle fa-lg"  style="color: black"></i><font color="crimson" size=4px><b> &nbsp Book appointment</b></font></a></li><br>
				<li><a href ="viewbook.jsp?userid=<%= session.getAttribute("id") %>"><i class="fa fa-plus-circle fa-lg"  style="color: black"></i><font color="crimson" size=4px><b> &nbsp View appointment</b></font></a></li><br>
							<li><a href ="viewstatus.jsp?userid=<%= session.getAttribute("id") %>"><i class="fa fa-plus-circle fa-lg"  style="color: black"></i><font color="crimson" size=4px><b> &nbsp View Status</b></font></a></li><br>
